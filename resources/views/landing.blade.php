...
@section('content')
    <div class="text-center py-20">
        <!-- Hero Section -->
        <h1 class="text-4xl font-bold text-blue-600 mb-4">Welcome to Yappr</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 text-center">
        <div class="p-6 bg-white shadow rounded">
            ...
            <p class="text-gray-600">Post yap and let the world know what’s on your mind.</p>
        </div>
        <div class="p-6 bg-white shadow rounded">
            <h2 class="text-xl font-semibold mb-2">Engage with Others</h2>
            <p class="text-gray-600">Like and interact with yaps from people around the globe.</p>
        </div>
        <div class="p-6 bg-white shadow rounded">
